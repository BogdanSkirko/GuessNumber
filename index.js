...
getButtonClick.addEventListener('click', function () 
  ...
  secretNumber < guess ? getCorrect.textContent ='Too High!' : getCorrect.textContent = 'to Low!!!';
  //When player WIN
  if (secretNumber === guess) {
    ...
    getScore.textContent > getHighscore.textContent ? getHighscore.textContent = getScore.textContent: 
  ...
  getAgain.addEventListener('click',function(){
    ...
    getHighscore.textContent = getScore.textContent < getHighscore.textContent ? getScore.textContent : getHighscore.textContent
